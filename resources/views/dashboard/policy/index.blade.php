    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <div class="card">
        <div class="card-header border-bottom">
          <h5 class="card-title mb-3">سياسة الخصوصية</h5>
          <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
            <div class="col-md-4 user_role">
                <a href="{{ route('policys.create') }}">
          ...
          <table class="datatables-users table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $policy->des }}</td>
                    <td>
                        <a href="{{ route('policys.edit',['id'=>$policy->id]) }}">
                            <button class="btn btn-secondary">تعديل</button>
                        </a>
                    </td>
                    <td>
                        <form   action="{{ route('policys.delete',['id'=>$policy->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
