...
<div class="container pt-5">
    <div class="card shadow-sm border-0">
        <div class="d-flex justify-content-between align-items-center p-3 border-bottom">
            <h5 id="AddUserLabel" class="mb-0">انشاء مادة جديدة</h5>
        </div>
        <div class="card-body">
            <form class="add-new-user" id="addNewUserForm" action="{{ route('material.store') }}" method="POST" enctype="multipart/form-data"   >
                @csrf
                <div class="row g-3">
                    <!-- Name Field -->
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <select id="add_rating" name="term" class=" form-select" data-placeholder="Size">
                            <option value="">اختر</option>
                            <option value="ترم_أول" >ترم_أول</option>
                            <option value="ترم_ثاني" >ترم_ثاني</option>
                            {{-- {{ $rating->status_rat == 1 ? 'selected' :'' }} --}}
                          </select>
                        @error('term')
                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" class="form-control" id="add-user-fullname" placeholder="المادة" name="title" required>
                        @error('title')
                        <div class="alert alert-danger mt-2">{{ $message }}</div>
                        @enderror
                    </div>
